...
namespace LabEight
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(SubstringSearch.KMPSearch(text, pattern).Length);
            foreach (var VARIABLE in SubstringSearch.KMPSearch(text, pattern))
            {
                Console.Write(VARIABLE+" ");
            }
            /*int[] table = SubstringSearch.KMP_Table(test);
